...
export default function Home() {
    ...
    return (
        <Box display={'flex'} gap={5} flexDir={{ base:'column',sm: 'column', md: 'column', lg: 'row' }}>
            ...
            <Box  display={{ lg: "none", md: "flex", sm: 'flex', base: 'flex' }} flexDir={'row'} alignItems={'center'} justifyContent={'space-around'}>
                <Box>
                    <MobileDrawer/> 
                </Box>
                <HStack>
                    ...
                    <Text className='pacifio' color={'#FFFFFF'} fontSize={'32px'} fontWeight={400}>NFTify</Text>
                </HStack>
                <Box>
                <Button className='poppins16' w={'156px'} h={'52px'} borderRadius={'20px'} background={'linear-gradient(131deg, #7C0F35 0%, #581266 100%)'} color={'white'}>
                    Connect
                </Button>
                </Box>
            </Box>
            ...
            <Box w={['90%','90%','90%','80%']} m={'auto'}>
                ...
                <Box height={'850px'}
                    ...
                    {data?.map((el) => (
                        <SimpleGrid key={el.fdv} mt={2} columns={[1, 1, 2, 4]}>
